...
const [selectedType,setSelectedType] = useState<"student" | "faculty" | null>(null)
    ...
    const handleRemove = (fieldName: any, itemToRemove: string) => {
      ...
      const handleAddUsers = () => {
        ...
        const mergedUsers = [...individualsUsers, ...filteredUsers, ...filteredFacultyUsers]
...
<View style={styles.paddingContainer}>
              ...
              <View style={styles.individualsContainer}>
                ...
                <DummyButton  onPress={() => actionSheetRef.current?.show()} toShowCross={false} text={ "Search Name"} icon={<Search width={20} height={20} />} />
...
<DummyButton label="University" onPress={()=>universityActionSheetRef.current?.show()} toShowCross={!!community.name} text={community.name ? community.name : "If you are a student choose your current year"} icon={<NavArrowDown width={20} height={20} />} />
...
/>
      ...
      >
            ...
            <SubscribedUniveristyBottomSheet options={userProiledata?.email || []} value={ []} onSelect={(val)=>setValue('community', val)} err={false} />
