...
const ProfileStudentForm = ({
  ...
  return (
    <View className="w-full  flex flex-col gap-8 items-center">
      ...
      <View className="w-full flex flex-col gap-3 mb-4">
        <View
        ...
        <View className="w-full flex flex-col relative mb-4">
          ...
          <Text className={`text-2xs text-neutral-400 text-center`}>
            If your major is not listed, choose the one that is closest to your
            current major.
          </Text>
